      ...
      <body className="min-h-full">
        <div className="site-grid min-h-screen">
          <div className="mx-auto flex min-h-screen w-full max-w-7xl flex-col px-4 py-4 sm:px-6 lg:px-8">
            ...
            <footer className="footer-grid relative mt-8 overflow-hidden rounded-2xl border border-white/8 px-6 py-10">
              <div className="grid gap-8 lg:grid-cols-[1.2fr_2fr]">
                <div className="space-y-4">
                  ...
                  {/* "Powered by Fyxvo" animated badge */}
                  <div className="inline-flex items-center gap-1.5 rounded-full border border-orange-500/20 bg-orange-500/8 px-3 py-1">
                    <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-orange-400" />
                    <span className="text-[10px] uppercase tracking-[0.2em] text-orange-400/80">Powered by Fyxvo</span>
                  </div>
